...
public class ThriftShip implements org.apache.thrift.TBase<ThriftShip, ThriftShip._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftShip> {
  ...
  private static final _Fields optionals[] = {_Fields.OWNER,_Fields.TYPE,_Fields.PROPERTIES,_Fields.EQUIPMENT};
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter17 : struct.properties.entrySet())
            {
      ...
      if (struct.equipment != null) {
        if (struct.isSetEquipment()) {
          oprot.writeFieldBegin(EQUIPMENT_FIELD_DESC);
          {
            ...
            for (ThriftEquipment _iter18 : struct.equipment)
            {
              _iter18.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter19 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetEquipment()) {
        {
          ...
          for (ThriftEquipment _iter20 : struct.equipment)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.properties = new HashMap<String,String>(2*_map21.size);
          String _key22;
          String _val23;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.equipment = new ArrayList<ThriftEquipment>(_list25.size);
          ThriftEquipment _elem26;
          for (int _i27 = 0; _i27 < _list25.size; ++_i27)
          {
            _elem26 = new ThriftEquipment();
            _elem26.read(iprot);
            struct.equipment.add(_elem26);
          }
        }
        struct.setEquipmentIsSet(true);
      }
