      ...
      if (struct.items != null) {
        if (struct.isSetItems()) {
          oprot.writeFieldBegin(ITEMS_FIELD_DESC);
          {
            ...
            for (ThriftShip _iter44 : struct.items)
            {
              _iter44.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.messages != null) {
        if (struct.isSetMessages()) {
          oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
          {
            ...
            for (String _iter45 : struct.messages)
            {
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (ThriftShip _iter46 : struct.items)
          {
            _iter46.write(oprot);
          }
        }
      ...
      if (struct.isSetMessages()) {
        {
          ...
          for (String _iter47 : struct.messages)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.items = new ArrayList<ThriftShip>(_list48.size);
          ThriftShip _elem49;
          for (int _i50 = 0; _i50 < _list48.size; ++_i50)
          {
            _elem49 = new ThriftShip();
            _elem49.read(iprot);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.messages = new ArrayList<String>(_list51.size);
          String _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = iprot.readString();
            struct.messages.add(_elem52);
          }
        }
        struct.setMessagesIsSet(true);
      }
