            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new ArrayList<ThriftShip>(_list10.size);
                ThriftShip _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = new ThriftShip();
                  _elem11.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftGameState struct) throws org.apache.thrift.TException {
      ...
      if (struct.items != null) {
        oprot.writeFieldBegin(ITEMS_FIELD_DESC);
        {
          ...
          for (ThriftShip _iter13 : struct.items)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetItems()) {
        {
          ...
          for (ThriftShip _iter14 : struct.items)
          {
            _iter14.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.items = new ArrayList<ThriftShip>(_list15.size);
          ThriftShip _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = new ThriftShip();
            _elem16.read(iprot);
