...
public class ThriftCommandList implements org.apache.thrift.TBase<ThriftCommandList, ThriftCommandList._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftCommandList> {
  ...
  public List<ThriftCommand> commands; // required
  ...
  private static final _Fields optionals[] = {_Fields.PLAYER};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commands = new ArrayList<ThriftCommand>(_list46.size);
                ThriftCommand _elem47;
                for (int _i48 = 0; _i48 < _list46.size; ++_i48)
                {
                  _elem47 = new ThriftCommand();
                  _elem47.read(iprot);
                  struct.commands.add(_elem47);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftCommandList struct) throws org.apache.thrift.TException {
      ...
      if (struct.commands != null) {
        oprot.writeFieldBegin(COMMANDS_FIELD_DESC);
        {
          ...
          for (ThriftCommand _iter49 : struct.commands)
          {
            _iter49.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetCommands()) {
        {
          ...
          for (ThriftCommand _iter50 : struct.commands)
          {
            _iter50.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.commands = new ArrayList<ThriftCommand>(_list51.size);
          ThriftCommand _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = new ThriftCommand();
            _elem52.read(iprot);
            struct.commands.add(_elem52);
          }
        }
        struct.setCommandsIsSet(true);
      }
