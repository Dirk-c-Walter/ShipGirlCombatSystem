            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commands = new ArrayList<ThriftCommand>(_list28.size);
                ThriftCommand _elem29;
                for (int _i30 = 0; _i30 < _list28.size; ++_i30)
                {
                  _elem29 = new ThriftCommand();
                  _elem29.read(iprot);
                  struct.commands.add(_elem29);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftCommandList struct) throws org.apache.thrift.TException {
      ...
      if (struct.commands != null) {
        oprot.writeFieldBegin(COMMANDS_FIELD_DESC);
        {
          ...
          for (ThriftCommand _iter31 : struct.commands)
          {
            _iter31.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetCommands()) {
        {
          ...
          for (ThriftCommand _iter32 : struct.commands)
          {
            _iter32.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.commands = new ArrayList<ThriftCommand>(_list33.size);
          ThriftCommand _elem34;
          for (int _i35 = 0; _i35 < _list33.size; ++_i35)
          {
            _elem34 = new ThriftCommand();
            _elem34.read(iprot);
